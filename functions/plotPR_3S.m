...
fileNameEps = ['./Figures/' desc_name '_' ds_name '_' '_N' num2str(exp_num_people) '_S3.eps'];
fileNameFig = ['./Figures/' desc_name '_' ds_name '_' '_N' num2str(exp_num_people) '_S3.fig'];
...
hLegend = legend(['Three-Stage: Ratio=' num2str(ratios(1))],['Three-Stage: Ratio=' num2str(ratios(2))],['Three-Stage: Ratio=' num2str(ratios(3))], 'Original','2nd Stage','1st Stage');
